      ...
      <div className="shell">
        ...
        <main>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10 }}>
            ...
            <button onClick={() => window.open("/stats", "_blank")} title="Ver stats (nueva ventana)" style={{ fontSize: 15, color: C.muted, background: C.surface, border: `3px solid ${C.ink}`, borderRadius: 10, padding: "6px 9px", cursor: "pointer", boxShadow: `0 3px 0 rgba(0,0,0,.35)` }}>📊</button>
